---
title: "ISUCON13に参加して60位（スコア32,592）だった"
date: 2023-12-03T20:00:00+09:00
draft: false
summary: "ISUCON13 にチーム「俺らのlatestMap」として出場し，結果はスコア 32,592 で 60 位でした．"
images:
...
ISUCON13 にチーム「俺らのlatestMap」として出場し，結果はスコア 32,592 で 60 位でした．
...
そして最後に，裏で進めていた「アイコン画像のハッシュをキャッシュしておく」「不要なトランザクションを削除する」といった改善を一つずつ試してみましたが，スコアの上昇には繋がらず（むしろ下がったので）マージせずに終えました．
